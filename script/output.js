...
Please dont steal my codes!!!
Please make a Review of this to help to make this mod more popular.
...
Block.defineBlock(25, "jumper", [["cauldron_top", 0], ["command_block", 0], ["cauldron_side", 0], ["cauldron_side", 0], ["cauldron_side", 0], ["cauldron_side", 0]], 46, false, 0);
...
Item.addShapedRecipe(items.emeraldsword, 1, 0, [
  " a ", 
  " a ", 
  " b "], ["a", items.emeraldingot, 0, "b", 280, 0]);
...
ModPE.setItem(429, "lavasword", 0, "lava sword");

ModPE.setItem(430, "watersword", 0, "water sword");
...
Item.setHandEquipped(504, 1);
Item.setHandEquipped(429, 1);
Item.setHandEquipped(430, 1);
...
//
ModPE.setItem(416, "hypershooter", 0, "Hyper shoter");//
ModPE.setItem(472, "tntshooter", 0, "tnt shooter", 0);//
ModPE.setItem(415, "sheeptntthrower", 0, "sheep TNT thrower", 0);
ModPE.setItem(items.tntrocket, "tntrocket", 0, "TNT rocket");
ModPE.setItem(450, "meteorsheep", 0, "Meteor sheep", 0);
ModPE.setItem(411, "flyingtnt", 0, "flying TNT", 0);
ModPE.setItem(501, "instanttnt", 0, "instant TNT", 0);
ModPE.setItem(503, "tntsword", 0, "TNT sword", 1);
ModPE.setItem(502, "fireworks_charge", 0, "chicken TNT", 0);
ModPE.setItem(504, "hypertntsword", 0, "Hyper TNT sword", 1);
ModPE.setItem(505, "pigtnt", 0, "pig TNT", 0);//ok
...
Item.defineArmor(508, "tntboots", 0, "TNT boots","armor/tnt_1.png", 2, 351, ArmorType.boots);
Item.defineArmor(509, "tntleggings", 0, "TNT leggings","armor/tnt_2.png", 6, 360, ArmorType.leggings);
Item.defineArmor(510, "tntchestplate", 0, "TNT chestplate","armor/tnt_1.png", 12, 354, ArmorType.chestplate);
Item.defineArmor(511, "tnthelmet", 0, "TNT helmet","armor/tnt_1.png", 6, 399, ArmorType.helmet);
Item.defineArmor(478, "speedboots", 0, "speed boots","armor/tnt_1.png", 2, 315, ArmorType.boots);
Item.defineArmor(412, "jetpack", 0, "jetpack","armor/tntarmor.png", 2, 353, ArmorType.chestplate);
Item.defineArmor(410, "dragonglider", 0, "dragon glider","armor/dragon.png", 2, 351, ArmorType.chestplate);

Item.setMaxDamage(508, 5000);
Item.setMaxDamage(501, 1000);
Item.setMaxDamage(503, 80);
Item.setMaxDamage(504, 200);
...
//Item.addShapedRecipe(
Item.addShapedRecipe(450, 1, 0, [
	"wtw",
	"twt",
	"wtw"], ["w", 35, 0, "t", 46, 0]);
Item.addShapedRecipe(503, 1, 0, [
  " a ",
  " a ",
  " b "], ["a", 46, 0, "b", 280, 0]);
...
Item.addShapedRecipe(412, 1, 0, [
  "aba", 
  "a a", 
  "c c"], ["a", 265, 0, "b", 331, 0, "c",325, 10]);
Item.addShapedRecipe(410, 1, 0, [
  "aaa", 
  "b b", 
  " c "], ["a", 35, 0, "b", 265, 0, "c", 334, 0]);

Item.addShapedRecipe(416, 1, 0, [
  " a ", 
  "bcb", 
  "bcb"], ["a", 46, 0, "b", 265, 0, "c", 331, 0]);
Item.addShapedRecipe(472, 1, 0, [
  " a ", 
  "bcb", 
  "bcb"], ["a", 46, 0, "b", 265, 0, "c", 331, 0]);
Item.addShapedRecipe(415, 1, 0, [
  " a ", 
  "bbb", 
  "cdc"], ["a", 46, 0, "b", 35, 0, "c", 265, 0, "d", 331, 0]);
...
if(Player.getCarriedItem()==416&&dauer==false){
dauer=true;
}
...
function destroyBlock(x, y, z, side) {
  ...
  if(rot==34){
	...
	if (blockId == lucky) {
        ...
        bob=Level.spawnMob(x+4,y,z+4,41);
        Entity.setNameTag(bob, "BOB");
        schwein=Level.spawnMob(x-4,y,z+4,12);
...
*/
  ...
  if(Player.getCarriedItem()==508){
    Player.setArmorSlot(3, 508, 0);
    Player.addItemInventory(508, -1);
  }
  if(Player.getCarriedItem()==505){
    Mathe=Level.spawnMob(x, y+1, z, 65, "mob/pig.png");
    Level.spawnMob(x, y+1, z, 65, "mob/pig.png");
    steak=true;
    Player.addItemInventory(505, -1);
  }
  if(Player.getCarriedItem()==502&&rupf==false){
   chicken=Level.spawnMob(x, y, z, 65);
   rupf=true;
   Player.addItemInventory(502, -1);
  }
	if(Player.getCarriedItem()==450&&activate==false){
    sheep = Level.spawnMob(x, y+1, z, 13, "mob/sheep_14.png");
		Entity.setNameTag(sheep, "§cBummmmm!");
    Entity.setVelY(sheep, 3);
    activate=true;
...
//if(Entity.getEntityTypeId(e)==33&&Player.getArmorSlot(1), 510){
//Player.setHealth(20);
//}
//}
function modTick(){
...
//shoot arrows at the target
  ...
  if(Entity.getVelY(Player.getEntity()) <= -0.5&&Player.getArmorSlot(1)==410&&ride==false){
  ...
  if(Player.getArmorSlot(1)==412){
    shootEntity(Player.getEntity(), 0.3, 0.3, 0.3);
  }
  if(dauer==true&&Player.getCarriedItem()==416){
    var ShootDir = lookDir(getYaw(), getPitch());
  ...
  if(Level.getTile(Player.getX(), Player.getY()-2, Player.getZ())==25){
    Entity.setVelY(Player.getEntity(), 2, 2, 2);
  }
  if(Player.getArmorSlot(3)==508){
    setTile(Player.getX(), Player.getY()-2, Player.getZ(), 46);
  }
  if(steak==true){
    uhr++;
  }
  if(wurst==false&&steak==true){
    schwein = Level.spawnMob(Entity.getX(Mathe), Entity.getY(Mathe), Entity.getZ(Mathe), 12, "mob/pig.png");
  ...
  if(jump==true){
    fly++
    ModPE.showTipMessage(ChatColor.RED + "Welcome to\n" + ChatColor.BLUE + "explosives Mod by Paper Benni 2\n" + ChatColor.YELLOW + "type/help for more informations!");
  }
  if(fly==70){
    jump=false;
    fly=0;
...
function turm(x, y, z){
  var mobId = Math.floor(Math.random()*(mobValues.length));
  pig1=Level.spawnMob(x, y, z, mobValues[mobId]);
  pig2=Level.spawnMob(x, y, z, mobValues[mobId]);
  rideAnimal(pig2, pig1);
  pig3=Level.spawnMob(x, y, z, mobValues[mobId]);
  rideAnimal(pig3, pig2);
  pig4=Level.spawnMob(x, y, z, mobValues[mobId]);
  rideAnimal(pig4, pig3);
  pig5=Level.spawnMob(x, y, z, mobValues[mobId]);
  rideAnimal(pig5, pig4);
  pig6=Level.spawnMob(x, y, z,mobValues[mobId]);
  rideAnimal(pig6, pig5);
  preventDefault();
}
